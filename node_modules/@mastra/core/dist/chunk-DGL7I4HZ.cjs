...
var MastraScorer = class _MastraScorer {
  ...
  toMastraWorkflow() {
    const workflowSteps = this.steps.map((scorerStep) => {
      return chunkZWWHTQ72_cjs.createStep({
        id: scorerStep.name,
    ...
    const workflow = chunkZWWHTQ72_cjs.createWorkflow({
  ...
  async executePromptStep(scorerStep, tracingContext, context) {
    ...
    const judge = new chunkZWWHTQ72_cjs.Agent({
      name: "judge",
      model: resolvedModel,
      instructions,
    ...
    if (scorerStep.name === "generateScore") {
      ...
      if (resolvedModel.specificationVersion === "v2") {
        result = await chunkZWWHTQ72_cjs.tryGenerateWithJsonFallback(judge, prompt, {
          structuredOutput: {
            schema
          },
          tracingContext
...
function isWorkflow(target) {
  return target instanceof chunkZWWHTQ72_cjs.Workflow;
}
...
//# sourceMappingURL=chunk-DGL7I4HZ.cjs.map
//# sourceMappingURL=chunk-DGL7I4HZ.cjs.map