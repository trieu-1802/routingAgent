...
export declare function getSerializedAgentTools(tools: Record<string, unknown>, partial?: boolean): Promise<Record<string, SerializedTool>>;
...
export declare function getAgentsHandler({ mastra, runtimeContext, partial, }: Context & {
